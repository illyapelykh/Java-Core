...
public abstract class Person {
	 ...
	 * salary(). In each concrete class create constant TYPE_PERSON. Output type
	 * of person in each constructors. Create array of Person and add some
	 * Teachers, Cleaners and Students to it. Call method print() for all of it.
